...
\begin{align*}
    \frac{d}{d\alpha} \sqbracket{ \log \paren {p(y_2, y_1, y_0 \mid \alpha) } } &= - 0 - 0 - \frac{1}{2\sigma^2} \sqbracket{ -2\alpha (y_2 - \alpha y_1) - 2\alpha (y_1 - \alpha y_0) } - 0 \\
...
To prevent this issue, we might assume that the distribution of our dat is Normal then draw the probabilities of each data point from this distribution instead.
